...
else if (isset($_POST['form_sent']))
{
	...
	$not_robot = (isset($_POST['not_robot'])) ? $_POST['not_robot'] : '0';
	...
	if ($pun_config['o_regs_report'] == '1')
	{
		...
		$mail_message = 'User \''.$username.'\' registered in the forums at '.$base_url."\n\n".'User profile: '.$base_url.'/profile.php?id='.$new_uid."\n\n".'-- '."\n".'Forum Mailer'."\n".'(Do not reply to this message)';
	...
	if ($pun_config['o_regs_verify'] == '1')
	{
		...
		$mail_message = str_replace('<login_url>', $base_url.'/login.php', $mail_message);
...
<?php endif; ?>						<label><input type="checkbox" name="not_robot" value="1" />&nbsp;<?php echo $lang_prof_reg['Not robot'] ?><br /></label>
					</div>
				</fieldset>
			</div>
			<div class="inform">
