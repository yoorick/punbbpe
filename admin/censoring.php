...
{
	confirm_referrer('admin/censoring.php');
	...
	redirect($base_url.'/admin/censoring.php', 'Censor word added. Redirecting &hellip;');
}
...
else if (isset($_POST['update']))
{
	...
	redirect($base_url.'/admin/censoring.php', 'Censor word updated. Redirecting &hellip;');
}
...
else if (isset($_POST['remove']))
{
	...
	redirect($base_url.'/admin/censoring.php', 'Censor word removed. Redirecting &hellip;');
}
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="censoring" method="post" action="<?php echo $base_url ?>/admin/censoring.php?action=foo">
				<div class="inform">
					<input type="hidden" name="csrf_hash" value="<?php echo csrf_hash() ?>" />
					<fieldset>
						<legend>Add word</legend>
						<div class="infldset">
							<p>Enter a word that you want to censor and the replacement text for this word. Wildcards are accepted (i.e. *some* would match somewhere and lonesome). Censor words also affect usernames. New users will not be able to register with usernames containing any censored words. The search is case insensitive. <strong>Censor words must be enabled in <a href="<?php echo $base_url ?>/admin/options.php#censoring">Options</a> for this to have any effect.</strong></p>
							<table  cellspacing="0">
							<thead>
								<tr>
