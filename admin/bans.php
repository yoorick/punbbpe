...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="bans2" method="post" action="<?php echo $base_url ?>/admin/bans.php">
				<div class="inform">
...
{
	confirm_referrer('admin/bans.php');
	...
	redirect($base_url.'/admin/bans.php', 'Ban '.(($_POST['mode'] == 'edit') ? 'edited' : 'added').'. Redirecting &hellip;');
}
...
{
	confirm_referrer('admin/bans.php', true);
	...
	redirect($base_url.'/admin/bans.php', 'Ban removed. Redirecting &hellip;');
}
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="bans" method="post" action="<?php echo $base_url ?>/admin/bans.php?action=more">
				<div class="inform">
					<input type="hidden" name="csrf_hash" value="<?php echo csrf_hash() ?>" />
					<fieldset>
...
<?php endif; ?>							</table>
							<p class="linkactions"><a href="<?php echo $base_url ?>/admin/bans.php?edit_ban=<?php echo $cur_ban['id'] ?>">Edit</a> - <a href="<?php echo $base_url ?>/admin/bans.php?del_ban=<?php echo $cur_ban['id'].'&amp;csrf_hash='.csrf_hash() ?>">Remove</a></p>
						</div>
					</fieldset>
				</div>
<?php
