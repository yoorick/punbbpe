...
{
	confirm_referrer('admin/ranks.php');
	...
	redirect($base_url.'/admin/ranks.php', 'Rank added. Redirecting &hellip;');
}
...
else if (isset($_POST['update']))
{
	...
	redirect($base_url.'/admin/ranks.php', 'Rank updated. Redirecting &hellip;');
}
...
else if (isset($_POST['remove']))
{
	...
	redirect($base_url.'/admin/ranks.php', 'Rank removed. Redirecting &hellip;');
}
