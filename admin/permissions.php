...
{
	confirm_referrer('admin/permissions.php');
	...
	redirect($base_url.'/admin/permissions.php', 'Permissions updated. Redirecting &hellip;');
}
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form method="post" action="<?php echo $base_url ?>/admin/permissions.php">
