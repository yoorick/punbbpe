		...
		<div id="adstats" class="box">
			<div class="inbox">
				<dl>
					<dt>PunBB version</dt>
					<dd>
						PunBB <?php echo $pun_config['o_cur_version'] ?> - <a href="<?php echo $base_url ?>/admin/index.php?action=check_upgrade">Check for upgrade</a><br />
...
<?php if ($pun_user['g_id'] == PUN_ADMIN): ?>					<dt>Environment</dt>
					<dd>
						...
						PHP: <?php echo phpversion() ?> - <a href="<?php echo $base_url ?>/admin/index.php?action=phpinfo">Show info</a><br />
