...
if (isset($_GET['action']) || isset($_POST['prune']) || isset($_POST['prune_comply']))
{
	...
	{
		confirm_referrer('admin/prune.php');
		...
		redirect($base_url.'/admin/prune.php', 'Posts pruned. Redirecting &hellip;');
	}
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form method="post" action="<?php echo $base_url ?>/admin/prune.php?action=foo">
				<div class="inform">
...
?>
	<div class="blockform">
		<h2><span>Prune</span></h2>
		<div class="box">
			<form id="prune" method="post" action="<?php echo $base_url ?>/admin/prune.php?action=foo" onsubmit="return process_form(this)">
				<div class="inform">
				<input type="hidden" name="csrf_hash" value="<?php echo csrf_hash() ?>" />
