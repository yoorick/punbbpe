...
'BBCode info 1'			=>	'BBCode is a collection of formatting tags that are used to change the look of text in this bulletin board. BBCode is based on the same principal as, and is very similar to, HTML. Below is a list of all the available BBCodes and instructions on how to use them.',
...
'Smilies info'			=>	'If you like (and if it is enabled), the board system can convert a series of smilies to images representations of that smiley. This bbs recognizes the following smilies and replaces them with images:'
