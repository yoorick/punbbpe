...
'Timezone'					=>	'Timezone',
'Timezone info'				=>	'For the site to display times correctly you must select your local timezone.',
'Language'					=>	'Language',
'Language info'				=>	'You can choose which language you wish to use to view the board system.',
'E-mail setting info'		=>	'Select whether you want your e-mail address to be viewable to other users or not and if you want other users to be able to send you e-mail via the site (form e-mail) or not.',
...
'Not robot'			=>	'I am not robot',
'Privacy options legend'	=>	'Set your privacy options',
'Save user/pass'			=>	'Save username and password between visits.',
'Save user/pass info'		=>	'This option sets whether the site should "remember" you between visits. If enabled, you will not have to login every time you visit the site. You will be logged in automatically. Recommended.',
...
'Username BBCode'			=>	'Usernames may not contain any of the text formatting tags (BBCode) that the bbs uses. Please choose another username.',
...
'Banned e-mail'				=>	'The e-mail address you entered is banned in this site. Please choose another e-mail address.',
...
'You are robot'			=>	'How pity! You are robot!',
